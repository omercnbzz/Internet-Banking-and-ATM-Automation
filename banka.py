...
def menu():
    while True:
        ...
        print("9-) Cüzdan Bİlgisi") 
        
        try:
            secim = int(input("Bir işlem seçiniz (1-9): "))
            if secim == 1:
                cekim_islemi()
            elif secim == 2:
                yatırma_islemi()
                ...
                print("Geçersiz seçim! Lütfen 1 ile 7 arasında bir değer giriniz.")
        except ValueError:
        ...
        try:             
             if kredi_secim==1:
                 ...
                 if ihtiyac_tutar>50000:
                     ...
                     print(f"Geri Ödemeniz 12 Ay Vade Sürecinde {aylık_odeme_ihtiyac_tutarı} TL olacaktır Eğer Onaylıyorsanız 'Banka Gişe Randevu' Kategorisine Geçiniz.")
                     break
                     ...
                     print(f"Geri Ödemeniz 12 Ay Vade Sürecinde {aylık_odeme_ihtiyac_tutarı2} TL olacaktır Eğer Onaylıyorsanız 'Banka Gişe Randevu' Kategorisine Geçiniz.")
                     break
             elif kredi_secim==2:
                 ...
                 print(f"Geri Ödemeniz 12 Ay Vade Sürecinde {aylık_odeme_faizli_konut_tutar} TL olacaktır Eğer Onaylıyorsanız 'Banka Gişe Randevu' Kategorisine Geçiniz.")
                 break
             elif kredi_secim==3:
                 ...
                 if tasıt_tutar>400000:
                     ...
                     print(f"Geri Ödemeniz 12 Ay Vade Sürecinde {aylık_odeme_tasıt_tutar} TL olacaktır Eğer Onaylıyorsanız 'Banka Gişe Randevu' Kategorisine Geçiniz.")
                     break
...
def mhizmetleri_randevu():
    ...
    print(f"Müşteri Hizmetlerinden Almak İstediğiniz Randevu Temsilcisi '{randevu_temsilci}', Günü '{randevu_gun}' ve Saati '{randevu_saat}' Ektedir.")
...
def gise_randevu():
    ...
    print(f"Banka Gişelerimizden Almak İstediğiniz Randevular Aşağıda Hizmetlerinize Sunulmuştur Uygun Randevuya Girmeniz Önemle Rica Olunur.")
    ...
    print(f"Banka Gişelerimizden Almak İstediğiniz Randevu Temsilcisi '{randevu_temsilci}', Günü '{randevu_gun}', saati '{randevu_saat}'") 
  

def cüzdan_bilgi():
    print(f"Güncel Cüzdan Bİlginiz {cüzdan} TL ")

def randevu_bilgi():
    print("Randevu Bilgi Sistemine Hoşgeldiniz. Oluşturmayı Planladığını Randevular Aşağıdaki Gibidir.")
    print(f"Güncel Olarak Sisteme Kayıtlı Oluşturmayı Planladığını Randevularınız: {randevu_liste}")
...
def kayıt_giris():
    try:
        ...
        if sifre_giris==sifre:
            print("Mobil Bankacılık Ve ATM Sistemimize Hoşgeldiniz. Menüden Gerekli İşlemlerinizi Gerçekleştirebilirsiniz.")
            menu()
        else:
